...
| Message Payload Mode | `Builder`, `Raw JSON`, or `Builder + Advanced JSON Merge`, the same embed/component builders used by Send Message, for posts that need embeds or Components v2 layout blocks |
